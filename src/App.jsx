...
const DEFAULT_SCRIPT_URL =
  'https://script.google.com/macros/s/AKfycby0Iw4rSGwPuqm7IXVF4WIwDw910hdMW2vP-jhXYeEtcSpSTaYJQC2DEk1OVcj7mGE/exec'
...
const textSimilarity = (a, b) => {
  ...
  for (let i = 1; i <= m; i++) {
    ...
    for (let j = 1; j <= n; j++) {
      curr[j] =
        x[i - 1] === y[j - 1] ? prev[j - 1] : 1 + Math.min(prev[j], curr[j - 1], prev[j - 1])
    }
    prev = curr
  }
...
const parseImportText = (text) => {
  ...
  if (lines.length > 1) {
    ...
    const isHeader =
      cells.length >= 2 &&
      cells.every((c) => c.split(/\s+/).length <= 3) &&
      cells.some((c) => headerWords.includes(c))
    if (isHeader) {
      startIdx = 1
    }
  }
...
const REMNOTE_LAST_PRACTICED = [
  ...
  {
    text: 'É fundamental reduzir a carga cognitiva do usuário em cada etapa do processo',
    lastPracticed: '2026-02-07',
  },
  {
    text: 'A floresta parecia calma durante o dia, mas à noite se tornava assustadora, cheia de sons estranhos.',
    lastPracticed: '2026-02-07',
  },
  {
    text: "I love languages; for me, I'm decoding the world around me.",
    lastPracticed: '2026-02-07',
  },
  ...
  {
    text: 'When I realized I almost missed the flight, I thought: "What a mess it could have been"',
    lastPracticed: '2026-02-07',
  },
  {
    text: 'No decorrer do ano, vamos revisar os resultados trimestralmente.',
    lastPracticed: '2026-02-07',
  },
  { text: 'o locador | o proprietário', lastPracticed: '2026-02-07' },
  {
    text: 'As roupas novas tinham várias manchas de tinta após a reforma.',
  ...
  {
    text: 'He is preparing for the university entrance exam and is attending an intensive preparatory course on weekends',
    lastPracticed: '2026-01-20',
  },
  ...
  {
    text: 'Everyone feels comfortable here. (two words, not "tudo mundo")',
    lastPracticed: '2026-01-19',
  },
  {
    text: "We like to bake sourdough bread at home using my dad's recipe from Malta",
    lastPracticed: '2026-01-19',
  },
  ...
  {
    text: 'O aumento de temperatura tem causado os chamados eventos extremos, como tempestades severas.',
    lastPracticed: '2025-12-26',
  },
  { text: "To scratch the car's paint", lastPracticed: '2025-12-26' },
  { text: 'To erase the board', lastPracticed: '2025-12-26' },
  {
    text: 'My neighborhood went through a process of gentrification in recent years',
    lastPracticed: '2025-12-15',
  },
  {
    text: 'Eu amo línguas; para mim, estou decodificando o mundo ao meu redor',
    lastPracticed: '2025-12-12',
  },
  { text: 'A apneia do sono é hereditária em minha família', lastPracticed: '2025-12-11' },
  {
    text: "The new tenant will only receive the keys on the contract's effective date",
    lastPracticed: '2025-12-01',
  },
  // Retaining
  ...
  {
    text: 'Era para ele ter embarcado há duas horas, mas seu voo foi cancelado',
    lastPracticed: '2026-02-07',
  },
  {
    text: 'Pelo que eu saiba, a reunião está marcada para amanhã de manhã',
    lastPracticed: '2026-02-07',
  },
  { text: 'The car skidded on the wet road/lane', lastPracticed: '2026-02-07' },
  {
    text: 'Quer saiba a resposta quer não, tem que esperar a sua vez',
    lastPracticed: '2026-02-07',
  },
  ...
  {
    text: "It is essential to reduce the user's cognitive load at each stage of the process",
    lastPracticed: '2026-01-05',
  },
  {
    text: 'O oftalmologista me deu uma receita de óculos depois do exame',
    lastPracticed: '2026-01-05',
  },
  ...
  {
    text: 'Na pesquisa, utilizamos a classificação de cartões para entender os modelos mentais dos usuários',
    lastPracticed: '2025-12-27',
  },
  ...
  {
    text: 'After reading the summary, I understood the premise of the book immediately',
    lastPracticed: '2025-12-26',
  },
  { text: "Where's the screwdriver?", lastPracticed: '2025-12-26' },
  {
    text: 'This topic is self-explanatory and requires no further explanation',
    lastPracticed: '2025-12-26',
  },
  { text: 'Daria tudo para não ter prova amanhã', lastPracticed: '2025-12-23' },
  {
    text: 'Este tópico é autoexplicativo e não requer mais explicações',
    lastPracticed: '2025-12-23',
  },
  {
    text: 'Male cats are more cuddly and affectionate than female cats, who are generally more independent',
    lastPracticed: '2025-12-15',
  },
  { text: 'To change the windshield wiper rubber', lastPracticed: '2025-12-13' },
  {
    text: 'Tendo em mente as limitações de tempo, precisamos ajustar o cronograma',
    lastPracticed: '2025-12-12',
  },
  {
    text: 'I need to schedule an appointment with the ophthalmologist to check my vision',
    lastPracticed: '2025-12-12',
  },
  { text: 'A Ana não vem trabalhar. Tem estado doente', lastPracticed: '2025-12-12' },
  {
    text: 'Preciso marcar uma consulta com o oftalmologista para checar minha visão',
    lastPracticed: '2025-12-12',
  },
  { text: 'I need to cross this item off the list', lastPracticed: '2025-12-12' },
  {
    text: 'Os gatos machos são mais fofos e carinhosos do que as gatas fêmeas, que geralmente são mais independentes',
    lastPracticed: '2025-12-12',
  },
  ...
  {
    text: 'The ophthalmologist gave me a glasses prescription after the exam',
    lastPracticed: '2025-12-11',
  },
  {
    text: 'Aprender um novo idioma é como decodificar um código secreto',
    lastPracticed: '2025-12-11',
  },
  ...
  {
    text: 'Ao comprar a TV, verifique o tamanho da tela em polegadas, pois é assim que os fabricantes listam',
    lastPracticed: '2025-12-02',
  },
  ...
  {
    text: 'She always knew that one day she would open her own business.',
    lastPracticed: '2025-12-01',
  },
  ...
  {
    text: 'Os enfermeiros estavam na linha de frente durante a pandemia',
    lastPracticed: '2025-12-01',
  },
  ...
  {
    text: 'O lançamento do aplicativo caiu de maduro depois de tanto esforço da equipe.',
  ...
  {
    text: 'Ele está se preparando para o vestibular e faz um cursinho intensivo aos finais de semana',
    lastPracticed: '2025-07-21',
  },
  ...
  // Stale
  {
    text: "If I'm not mistaken, the restaurant closes at ten (formal)",
    lastPracticed: '2026-02-07',
  },
  {
    text: 'The app launch was bound to happen after so much effort from the team.',
    lastPracticed: '2026-02-07',
  },
  {
    text: 'Throughout the year, we will review the results quarterly.',
    lastPracticed: '2026-01-20',
  },
  {
    text: 'O software apresentou uma trava inesperada durante a atualização',
    lastPracticed: '2026-01-08',
  },
  ...
  {
    text: 'Last time we visited, we barely saw any toucans in the reserve',
    lastPracticed: '2026-01-07',
  },
  ...
  {
    text: 'The software froze unexpectedly during the update (Block / Lock / Jam, depends on context)',
    lastPracticed: '2026-01-06',
  },
  { text: "It's clear that they need help with so much work.", lastPracticed: '2026-01-06' },
  {
    text: "It's useful that you review the material before the exam.",
    lastPracticed: '2026-01-06',
  },
  {
    text: 'Quaisquer que sejam as dificuldades, temos que enfrentá-las',
    lastPracticed: '2026-01-06',
  },
  {
    text: "It's easy for you (both) to understand the explanation with this example.",
    lastPracticed: '2026-01-06',
  },
  {
    text: 'your property may be rented with QuintoAndar or with an estate agent.',
    lastPracticed: '2026-01-06',
  },
  {
    text: 'Regarding the budget, we need to cut expenses. (Very formal)',
    lastPracticed: '2026-01-06',
  },
  {
    text: "she's been looking for a job for months (coloquial present perfect continuous)",
    lastPracticed: '2026-01-06',
  },
  {
    text: 'The steep roads of Ouro Preto are a challenge for tourists',
    lastPracticed: '2026-01-05',
  },
  {
    text: 'When she complains for no reason, it drives me crazy (gets on my nerves)',
    lastPracticed: '2026-01-05',
  },
  { text: "You are the woman that I've always dreamed of meeting", lastPracticed: '2026-01-05' },
  {
    text: "Since the first meeting, we've (casual) gotten along well and worked in sync.",
    lastPracticed: '2026-01-05',
  },
  { text: 'They discovered a hidden passage behind the bookshelf', lastPracticed: '2026-01-05' },
  {
    text: "The public program aims to teach literacy to adults who didn't have the opportunity to study (To teach literacy / To make literate)",
    lastPracticed: '2026-01-05',
  },
  {
    text: 'O atleta usou uma bandagem para proteger o ferimento no joelho',
    lastPracticed: '2026-01-05',
  },
  {
    text: "It's necessary that you (plural) finish this service soon.",
    lastPracticed: '2026-01-05',
  },
  ...
  {
    text: '(Refogar) Para a sopa, refogue cebola picada em manteiga antes de adicionar os legumes',
    lastPracticed: '2026-01-04',
  },
  { text: 'We slept in a bunk bed when we went camping', lastPracticed: '2026-01-04' },
  {
    text: "In the research, we used card sorting to understand the users' mental models.",
    lastPracticed: '2026-01-04',
  },
  ...
  {
    text: 'Agora que a empresa está bem das pernas, podemos expandir.',
    lastPracticed: '2026-01-03',
  },
  {
    text: 'Tendo em mente o prazo apertado, precisamos trabalhar rápido.',
    lastPracticed: '2026-01-03',
  },
  {
    text: 'O novo inquilino vai receber as chaves apenas no dia da vigência do contrato',
    lastPracticed: '2026-01-03',
  },
  ...
  {
    text: 'Keeping in mind the time constraints, we need to adjust the schedule',
    lastPracticed: '2026-01-01',
  },
  { text: 'My grandmother learned to sew beautiful dresses by hand', lastPracticed: '2025-12-31' },
  {
    text: 'She went to look for the information on the official site',
    lastPracticed: '2025-12-31',
  },
  { text: 'Stop being a pussy and just talk to her', lastPracticed: '2025-12-31' },
  {
    text: 'The temperature rise has caused the so-called extreme events, like severe storms.',
    lastPracticed: '2025-12-31',
  },
  ...
  {
    text: 'Vocês têm que pagar, quer queiram quer não, caso contrário, chamamos a polícia',
    lastPracticed: '2025-12-31',
  },
  { text: 'O que quer que diga, já ninguém acredita nele', lastPracticed: '2025-12-31' },
  {
    text: 'When buying a TV, check the screen size in inches, as that is how manufacturers list it',
    lastPracticed: '2025-12-23',
  },
...
const i18n = {
  'pt-BR': {
    ...
    importDesc:
      'Importe suas palavras em massa usando um CSV ou texto colado. Use negrito para marcar a palavra-chave na frase.',
    ...
    apiKeyDesc:
      'Chave gratuita do Google AI Studio (aistudio.google.com). Armazenada só no seu dispositivo.',
    apiKeyPlaceholder: 'AIza...',
    apiKeySaved: 'Chave salva ✓',
    sheetsSync: 'Sincronização Google Sheets',
    sheetsSyncDesc:
      'Mantenha seus cartões sincronizados em todos os dispositivos via Google Sheets. Cole a URL do Apps Script abaixo.',
    sheetsSyncWarn:
      '⚠ Esta URL funciona como uma chave de acesso aos seus dados. Não compartilhe screenshots desta tela nem cole a URL em mensagens.',
  ...
  en: {
    ...
    importDesc:
      'Import your words in bulk using a CSV or pasted text. Use bold to mark the keyword in the sentence.',
    ...
    sheetsSyncDesc:
      'Keep your cards synced across all devices via Google Sheets. Paste your Apps Script URL below.',
    sheetsSyncWarn:
      "⚠ This URL functions as the access key to your data. Don't share screenshots of this panel or paste the URL into chats.",
...
function CalendarHeatmap({ practiceDays, year, onYearChange }) {
  ...
  weeks.forEach((week, wi) => {
    ...
    if (validDay) {
      ...
      if (m !== lastMonth) {
        monthPositions.push({ month: m, weekIndex: wi })
        lastMonth = m
      }
    }
  })
  ...
  return (
    <div>
      ...
      {tooltip && (
        ...
        >
          ...
          <span style={{ color: T.textTertiary }}>
            {' '}
            {tooltip.count === 1 ? t.review1 : t.reviewN}{' '}
          </span>
      ...
      >
        <span style={{ fontFamily: font.mono, fontSize: 9, color: T.textTertiary, marginRight: 2 }}>
          {t.less}
        </span>
        {[T.heatEmpty, T.heat1, T.heat2, T.heat3].map((c, i) => (
          <div key={i} style={{ width: 10, height: 10, borderRadius: 2, background: c }} />
        ))}
        <span style={{ fontFamily: font.mono, fontSize: 9, color: T.textTertiary, marginLeft: 2 }}>
          {t.more}
        </span>
      </div>
    </div>
...
const getKeywordSpans = (card) => {
  if (Array.isArray(card.keywordSpans) && card.keywordSpans.length > 0) {
    return card.keywordSpans.filter(
      ([s, e]) => typeof s === 'number' && typeof e === 'number' && e > s
    )
  }
  if (
    card.keywordStart !== undefined &&
    card.keywordEnd !== undefined &&
    card.keywordStart !== card.keywordEnd
  ) {
...
function PhraseDisplay({
  ...
  if (!effective || effective.length === 0) {
    return (
      <span style={wrap}>
        <span style={{ color: textColor }}>{phrase}</span>
      </span>
    )
  }
  ...
  sorted.forEach(([start, end], i) => {
    ...
    if (s > cursor)
      parts.push(
        <span key={`p${i}`} style={{ color: textColor }}>
          {phrase.slice(cursor, s)}
        </span>
      )
    if (end > s)
      parts.push(
        <span key={`b${i}`} style={boldStyle}>
          {phrase.slice(s, end)}
        </span>
      )
    cursor = Math.max(cursor, end)
  ...
  if (cursor < phrase.length)
    parts.push(
      <span key="tail" style={{ color: textColor }}>
        {phrase.slice(cursor)}
      </span>
    )
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
      <div>
        ...
        {ptText.trim() && parsed && (
          <div
            style={{ marginTop: 10, padding: '8px 12px', background: T.keywordBg, borderRadius: 8 }}
          >
            <PhraseDisplay
              phrase={parsed.phrase}
              keywordStart={parsed.keywordStart}
              keywordEnd={parsed.keywordEnd}
            />
          </div>
        )}
        {ptText.trim() && !parsed && (
...
const DrawingCanvas = memo(
  forwardRef(function DrawingCanvas({ height = 200, onDrawingChange }, ref) {
...
function PracticeCard({
  ...
  totalDue,
  studyDirection,
  answerMode: answerModeProp = 'type',
  setAnswerMode,
  activeSession,
  liveElapsed,
  onStartTimer,
  ...
  const qualityButtons = [
    ...
    {
      q: 2,
      label: t.partiallyRecalled,
      icon: <MoonShapeIcon fill={0.5} size={18} color={T.text} />,
      days: intervals[1],
    },
    {
      q: 3,
      label: t.recalledWithEffort,
      icon: <MoonShapeIcon fill={0.75} pie size={18} color={T.text} />,
      days: intervals[2],
    },
    {
      q: 4,
      label: t.easilyRecalled,
      icon: <MoonShapeIcon fill={1} size={18} color={T.text} />,
      days: intervals[3],
    },
  ]
  ...
  const renderSkipBtn = () => (
    ...
    >
      ...
      <span
        style={{ fontFamily: font.body, fontSize: 13, fontWeight: 500, color: T.textSecondary }}
      >
        {t.skip}
      </span>
    </button>
  ...
  const speakBtn = (
    ...
    >
      {isSpeaking ? (
        <StopIcon size={13} color={T.textSecondary} />
      ) : (
      ...
      {editing ? (
        ...
        <div
          style={{
            ...
            margin: '0 auto',
            width: '100%',
            padding: mobile ? '24px 0 0' : '96px 0 0',
          }}
        >
          {/* Language label */}
          ...
          >
            <div style={{ maxWidth: mobile ? '100%' : 900 }}>{heroText}</div>
          </div>
          {/* Action button row */}
          <div
            style={{
            ...
            {!hasRevealed ? (
              <>
                ...
                {!mobile && setAnswerMode && (
                  <div
                    aria-hidden
                    style={{ width: 1, height: 20, background: T.border, margin: '0 6px' }}
                  />
                )}
          ...
          <div
            style={{
              maxWidth: mobile ? '100%' : 900,
              margin: mobile ? '12px auto 0' : hasRevealed ? '12px auto 0' : '28px auto 0',
              padding: mobile ? '0 16px' : 0,
            }}
          >
            {!hasRevealed &&
              (() => {
                ...
                const verifyDisabled = answerMode === 'type' ? !userAnswer.trim() : !hasDrawing
                const onVerify =
                  answerMode === 'type'
                    ? handleCheck
                    : () => {
                ...
                return (
                  <div style={{ textAlign: 'center' }}>
                    <button
                      ...
                      onMouseEnter={(e) => {
                        if (!verifyDisabled) e.currentTarget.style.opacity = '0.88'
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.opacity = '1'
                      }}
...
const WordRow = memo(function WordRow({
  ...
  const commitPt = (html) => {
    ...
    if (
      updated.word !== card.word ||
      updated.phrase !== card.phrase ||
      updated.translation !== card.translation ||
            ...
            {isNew && onTogglePriority && (
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke={card.priority ? T.accent : T.textTertiary}
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                >
    ...
    >
      <button
        ...
        style={{
          position: 'fixed',
          top: mobile ? 12 : 20,
          right: mobile ? 12 : `max(20px, calc((100vw - 1200px) / 2 + 36px))`,
          zIndex: 110,
          width: 44,
          height: 44,
          borderRadius: 9999,
      ...
      <div
        style={{
          padding: mobile ? '20px 16px 60px' : '36px 36px 60px',
          maxWidth: 1200,
          margin: '0 auto',
        }}
      >
...
function ImportPanel({ onImport, existingCount }) {
  ...
  const toHtml = (r, field) => {
    ...
    if (field === 'portuguese') {
      if (
        r.phrase &&
        r.keywordStart !== undefined &&
        r.keywordEnd !== undefined &&
        r.keywordStart !== r.keywordEnd
      ) {
      ...
      {fileLoaded && results.length > 0 && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span
              style={{ fontFamily: font.body, fontSize: 13, color: T.success, fontWeight: 500 }}
            >
              {results.length} {results.length === 1 ? t.word : t.wordsPlural} encontradas no
              arquivo
            </span>
          </div>
          <button
          ...
          >
            <div
              ...
              onMouseEnter={(e) => {
                ...
                if (c) c.style.borderColor = T.borderStrong
              }}
              onMouseLeave={(e) => {
                const c = e.currentTarget.firstChild
                if (c)
                  c.style.borderColor = allSelected || someSelected ? T.success : T.borderStrong
              }}
            >
              <div
                style={{
          ...
          {results.map((r, i) => {
            ...
            return (
              <div
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = isSelected ? 'transparent' : T.bgCardHover
                }}
              >
                <div
                ...
                {mobile ? (
                  ...
                  <>
                    ...
                    <EditableCell
                      html={toHtml(r, 'translation')}
                      onCommit={(html) => commitCell(i, 'translation', html)}
                      style={cellStyle}
                    />
                    <EditableCell
                      html={toHtml(r, 'portuguese')}
                      onCommit={(html) => commitCell(i, 'portuguese', html)}
                      style={cellStyle}
                    />
                  </>
                )}
      ...
      {errors.length > 0 && (
        <div
          style={{
            ...
            border: `1px solid rgba(181,134,11,0.12)`,
            borderRadius: T.radius,
            padding: 20,
          }}
        >
          ...
          {errors.slice(0, 5).map((err, i) => (
            ...
            >
              <span style={{ color: T.textTertiary }}>linha {err.line}:</span>{' '}
              {err.text.substring(0, 60)}
              {err.text.length > 60 ? '...' : ''}
            </div>
          ))}
        </div>
      ...
      {results.length === 0 && text.trim() && (
        <div
          style={{
            ...
            border: `1px solid rgba(196,72,62,0.12)`,
            borderRadius: T.radius,
            padding: 24,
            textAlign: 'center',
          }}
        ...
        >
          ...
          <div>
            <div style={{ fontFamily: font.body, fontSize: 14, fontWeight: 600, color: T.text }}>
              {importedCount}{' '}
              {importedCount === 1
                ? t.word + ' ' + t.importedSuccessSingular
                : t.wordsPlural + ' ' + t.importedSuccess}
            </div>
            <div
              style={{ fontFamily: font.body, fontSize: 13, color: T.textSecondary, marginTop: 2 }}
            >
              {t.goToWords}
            </div>
          </div>
...
const GSheets = {
  ...
  readMeta: async (scriptUrl) => {
    ...
    let deletedCards = {}
    try {
      practiceDays = JSON.parse(data.practiceDays || '{}')
    } catch {}
    try {
      deletedCards = JSON.parse(data.deletedCards || '{}')
    } catch {}
...
export default function VocabApp() {
  ...
  const [lastManualBackup, setLastManualBackup] = useState(() => {
    try {
      return Number(localStorage.getItem('vocab-last-manual-backup')) || 0
    } catch {
      return 0
    }
  })
  const [lastAutoSnapshot, setLastAutoSnapshot] = useState(() => {
    try {
      return Number(localStorage.getItem('vocab-last-snapshot')) || 0
    } catch {
      return 0
    }
  })
  ...
  useEffect(() => {
    practiceDaysRef.current = practiceDays
  }, [practiceDays])
  useEffect(() => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        if (r) {
          ...
          setSettings((prev) => ({
            ...prev,
            ...savedSettings,
            scriptUrl: savedSettings.scriptUrl || DEFAULT_SCRIPT_URL,
          }))
      ...
      try {
        const r = await window.storage.get('vocab-cards')
        if (r) localCards = JSON.parse(r.value)
      } catch {}
      try {
        const r = await window.storage.get('vocab-practice-days')
        if (r) localDays = JSON.parse(r.value)
      } catch {}
      try {
        const r = await window.storage.get('vocab-deleted')
        if (r) localDeleted = JSON.parse(r.value)
      } catch {}
      try {
        const r = await window.storage.get('vocab-study-time')
        if (r) localStudyTime = JSON.parse(r.value)
      } catch {}
      try {
        const r = await window.storage.get('vocab-active-session')
        if (r) localActiveSession = JSON.parse(r.value)
      } catch {}
      ...
      if (localActiveSession && localActiveSession.startedAt && localActiveSession.lastSeenAt) {
        ...
        if (gap < IDLE_CAP_MS) {
          ...
          if (accumulated > 0) {
            const nextStudyTime = {
              ...localStudyTime,
              [dateKey]: (localStudyTime[dateKey] || 0) + accumulated,
            }
  ...
  const setStudyTimeForDate = useCallback(
    (date, seconds) => {
      setStudyTime((prev) => {
        const next = { ...prev }
  ...
  const deleteStudyTimeForDate = useCallback(
    (date) => {
      setStudyTime((prev) => {
        const next = { ...prev }
        delete next[date]
  ...
  const stopTimer = useCallback(() => {
    ...
    if (finalSec > 0) {
      ...
      const next = {
        ...studyTimeRef.current,
        [dateKey]: (studyTimeRef.current[dateKey] || 0) + finalSec,
      }
      setStudyTime(next)
      persistStudyTime(next)
    }
  ...
  const heartbeat = useCallback(() => {
    ...
    if (gap >= IDLE_CAP_MS) {
      ...
      if (accumulated > 0) {
        const next = {
          ...studyTimeRef.current,
          [dateKey]: (studyTimeRef.current[dateKey] || 0) + accumulated,
        }
        setStudyTime(next)
        persistStudyTime(next)
      }
    ...
    const updated = {
      ...s,
      lastSeenAt: now,
      accumulatedSec: (s.accumulatedSec || 0) + Math.floor(gap / 1000),
    }
  ...
  const saveSettings = useCallback(async (newSettings) => {
    ...
    try {
      await window.storage.set('vocab-settings', JSON.stringify(newSettings))
    } catch (e) {
  ...
  const togglePriority = useCallback(
    (id) => {
      setCards((prev) => {
        const nc = prev.map((c) =>
          c.id === id ? { ...c, priority: !c.priority, modifiedAt: Date.now() } : c
        )
        setTimeout(() => save(cardsRef.current, practiceDaysRef.current), 0)
        return nc
      })
  ...
  const suspendCard = useCallback(
    (id) => {
      setCards((prev) => {
        const nc = prev.map((c) =>
          c.id === id ? { ...c, suspended: true, modifiedAt: Date.now() } : c
        )
        setTimeout(() => save(cardsRef.current, practiceDaysRef.current), 0)
        return nc
      })
  ...
  const unsuspendCard = useCallback(
    (id) => {
      setCards((prev) => {
        const nc = prev.map((c) =>
          c.id === id ? { ...c, suspended: false, modifiedAt: Date.now() } : c
        )
        setTimeout(() => save(cardsRef.current, practiceDaysRef.current), 0)
        return nc
      })
  ...
  const exportBackupToFile = useCallback(() => {
    ...
    a.href = url
    a.download = `vocabulario_backup_${today()}.json`
    a.click()
    URL.revokeObjectURL(url)
    const now = Date.now()
    try {
      localStorage.setItem('vocab-last-manual-backup', String(now))
    } catch {}
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        const now = Date.now()
        try {
          localStorage.setItem('vocab-last-snapshot', String(now))
        } catch {}
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      if (!s) return
      setLiveElapsed(
        (s.accumulatedSec || 0) + Math.max(0, Math.floor((Date.now() - s.lastSeenAt) / 1000))
      )
    }
    update()
  ...
  useEffect(() => {
    const onHide = () => {
      ...
      const updated = {
        ...
        lastSeenAt: now,
        accumulatedSec:
          (s.accumulatedSec || 0) + Math.max(0, Math.floor((now - s.lastSeenAt) / 1000)),
      }
  ...
  const newCardsIntroducedToday = useMemo(() => {
    ...
    return cards.filter((c) => c.firstReviewedAt === t && c.lastReview === t && (c.reps || 0) <= 1)
      .length
  }, [cards, tick])
  const dueCards = useMemo(() => {
    const due = cards.filter(
      (c) =>
        ...
        c.dueDate <= today() &&
        !skippedIds.has(c.id) &&
        (!c.dueAfter || Date.now() >= c.dueAfter)
    )
    // Three buckets:
  ...
  const sortedCards = useMemo(() => {
    ...
    return [...cards].sort((a, b) => {
      ...
      } else if (sortKey === 'translation') {
        va = (a.translation || '').toLowerCase()
        vb = (b.translation || '').toLowerCase()
      } else if (sortKey === 'phrase') {
        va = (a.phrase || '').toLowerCase()
        vb = (b.phrase || '').toLowerCase()
  ...
  const dueReview = useMemo(
    () =>
      dueCards.filter((c) => (c.reps || 0) > 0 || ((c.reps || 0) === 0 && c.firstReviewedAt))
        .length,
    [dueCards]
  )
  ...
  if (!authResolved) {
    return (
      ...
      >
        <span
          style={{ fontFamily: font.display, fontSize: 16, fontWeight: 700, color: T.textTertiary }}
        >
          carregando...
        </span>
      </div>
    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: font.body, fontSize: 15, color: T.textTertiary }}>
            Entre para acessar seus cartões
          </div>
        </div>
        <button
  ...
  if (dbError) {
    return (
      ...
      >
        <div style={{ fontFamily: font.display, fontSize: 20, fontWeight: 800, color: T.text }}>
          Couldn’t reach your database
        </div>
        <div style={{ fontFamily: font.body, fontSize: 14, color: T.textTertiary, maxWidth: 420 }}>
          Signed in as <strong>{user.email}</strong>. Check that the Realtime Database{' '}
          <strong>Rules</strong> are published and allow this account.
        </div>
        <div style={{ fontFamily: font.mono, fontSize: 12, color: T.textTertiary, opacity: 0.7 }}>
          {dbError}
        </div>
        <button
          onClick={() => signOutUser()}
  ...
  const practiceBadge =
    dueReview || dueNew
      ...
      : null
  const daysStudiedThisYear = Object.keys(practiceDays).filter(
    (d) => d.startsWith(String(new Date().getFullYear())) && studiedOnDay(practiceDays[d])
  ).length
  const navItems = [
    ...
    { id: 'words', label: t.words, badge: cards.filter((c) => !c.suspended).length || null },
    {
      id: 'heatmap',
      label: t.progress,
      badge: `${daysStudiedThisYear} ${settings.lang === 'en' ? 'days' : 'dias'}`,
    },
  ]
  const todayFormatted = new Date().toLocaleDateString(settings.lang === 'en' ? 'en-US' : 'pt-BR', {
    weekday: 'long',
    day: 'numeric',
    month: 'long',
  })
  ...
  const headerOnEnter = (e) => {
    e.currentTarget.style.borderColor = T.borderStrong
    e.currentTarget.style.background = T.bgCardHover
  }
  const headerOnLeave = (e) => {
    e.currentTarget.style.borderColor = T.border
    e.currentTarget.style.background = T.bgCard
  }
  const headerActions = (
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text }}>
      ...
      <div
        style={{
          padding: mobile ? '16px 16px 0' : '18px 36px 0',
          maxWidth: 1200,
          margin: '0 auto',
        }}
      >
        ...
        >
          ...
          >
            {navItems.map((item) => (
              <button
                ...
                onMouseEnter={(e) => {
                  if (view !== item.id) e.currentTarget.style.color = T.textSecondary
                }}
                onMouseLeave={(e) => {
                  if (view !== item.id) e.currentTarget.style.color = T.textTertiary
                }}
              >
                {item.label}
                {item.badge && (
          ...
          {!mobile && <div>{headerActions}</div>}
        </div>
      </div>
      <div
        style={{
          padding: mobile ? '20px 16px 100px' : '32px 36px 60px',
          maxWidth: 1200,
          margin: '0 auto',
        }}
      >
                ...
                >
                  {cards.length === 0
                    ...
                    : (() => {
                        ...
                        return next
                          ? `${t.nextReview}: ${new Date(next.dueDate + 'T12:00:00').toLocaleDateString('pt-BR', { day: 'numeric', month: 'short' })}`
                          : ''
                      })()}
                </div>
                {cards.length === 0 && (
        ...
        {view === 'words' && (
          <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                                ...
                                return (
                                  ...
                                  >
                                    <svg
                                      ...
                                      viewBox="0 0 24 24"
                                      fill="none"
                                      stroke={on ? T.bg : T.textSecondary}
                                      strokeWidth="2"
                                      strokeLinecap="round"
                                      strokeLinejoin="round"
                                      style={{
              ...
              <button
                onClick={() => {
                  ...
                  setCollapsedGroups(
                    next
                      ? new Set(['new', 'learning', 'young', 'mature', 'mastered', 'suspended'])
                      : new Set()
                  )
                }}
                style={{
            ...
            <Modal
              open={showImportInline}
              onClose={() => setShowImportInline(false)}
              title={t.importWords}
            >
              <ImportPanel
                onImport={(newCards) => {
                ...
                >
                  {[
                    ...
                    <span
                      ...
                      onMouseEnter={(e) => {
                        if (col.key) e.currentTarget.style.color = T.text
                      }}
                      onMouseLeave={(e) => {
                        if (col.key)
                          e.currentTarget.style.color =
                            sortKey === col.key ? T.text : T.textTertiary
                      }}
                    >
                      {col.label}
                      {col.key &&
                        (() => {
                          ...
                          return (
                            ...
                            >
                              <polyline
                                points="2,5 5,2 8,5"
                                stroke={ascActive ? on : idle}
                                strokeWidth={ascActive ? 2.5 : 1.6}
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                fill="none"
                              />
                              <polyline
                                points="2,9 5,12 8,9"
                                stroke={descActive ? on : idle}
                                strokeWidth={descActive ? 2.5 : 1.6}
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                fill="none"
                              />
                              ...
                              <div key={stage}>
                                ...
                                >
                                  <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    fill="none"
                                    stroke={isDark ? sc.darkText : sc.text}
                                    strokeWidth="2.5"
                                    strokeLinecap="round"
                                    style={{
                        ...
                        <div style={{ opacity: 0.6 }}>
                          ...
                          >
                            <svg
                              ...
                              strokeLinecap="round"
                              style={{
                                transform: suspendedCollapsed ? 'rotate(-90deg)' : 'rotate(0deg)',
                                transition: 'transform 0.15s',
                              }}
                            >
                              <polyline points="6 9 12 15 18 9" />
                            ...
                            <span
                              style={{ fontFamily: font.mono, fontSize: 11, color: T.textTertiary }}
                            >
        ...
        {view === 'heatmap' && (
          <Suspense
            fallback={
              <div style={{ padding: 40, textAlign: 'center', color: T.textTertiary }}>...</div>
            }
          >
            <RechartsModule>
              {({
                ...
                <>
                    ...
                    {[
                      {
                        ...
                        value: (() => {
                          ...
                          return Object.keys(practiceDays).filter(
                            (d) => d.startsWith(String(yr)) && studiedOnDay(practiceDays[d])
                          ).length
                        })(),
                      },
                      {
                        ...
                        value: (() => {
                          ...
                          while (true) {
                            ...
                            if (studiedOnDay(practiceDays[ds])) {
                              streak++
                              d.setDate(d.getDate() - 1)
                            } else break
                          }
                      ...
                      },
                      {
                        label: t.avgPerDay,
                        value: (() => {
                          const totals = Object.values(practiceDays)
                            .map(totalForDay)
                            .filter((v) => v > 0)
                      ...
                      <div
                        ...
                        style={{
                          ...
                          border: `1px solid ${T.border}`,
                          borderRadius: T.radius,
                          padding: mobile ? '14px 8px' : '22px 16px',
                          textAlign: 'center',
                        }}
                      >
                        {stat.editable && (
                  ...
                  {(() => {
                    ...
                    const data = aggregateStudyTime(studyTime, studyTimePeriod, range).map((b) => ({
                      ...
                      value:
                        studyTimePeriod === 'month' || studyTimePeriod === 'year'
                          ? +(b.seconds / 3600).toFixed(2)
                          : Math.round(b.seconds / 60),
                    }))
                    const yUnit =
                      studyTimePeriod === 'month' || studyTimePeriod === 'year' ? 'h' : 'm'
                    ...
                    return (
                      <div
                        style={{
                          ...
                          border: `1px solid ${T.border}`,
                          borderRadius: T.radius,
                          padding: mobile ? '16px 16px 8px' : '22px 24px 14px',
                          marginBottom: 14,
                        }}
                      >
                        <div
                        ...
                        {hasAny ? (
                          <ResponsiveContainer width="100%" height={mobile ? 180 : 220}>
                            ...
                            >
                              ...
                              <XAxis
                                dataKey="label"
                                tick={{ fill: T.textTertiary, fontFamily: font.mono, fontSize: 10 }}
                                axisLine={{ stroke: T.border }}
                                tickLine={false}
                                interval={mobile && studyTimePeriod === 'day' ? 4 : 0}
                              />
                              <YAxis
                                tick={{ fill: T.textTertiary, fontFamily: font.mono, fontSize: 10 }}
                                axisLine={false}
                                  ...
                                  if (active && payload && payload.length) {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        >
                                          {formatDuration(d.seconds, { short: true })}
                                        </div>
                                      </div>
                                    )
                                  }
                    ...
                    (() => {
                      ...
                      reviewedCards.forEach((c) => {
                        const elapsed = c.lastReview
                          ? Math.max(0, (nowDate - new Date(c.lastReview + 'T12:00:00')) / 86400000)
                          : 0
                      ...
                      const avgRecall =
                        reviewedCards.length > 0
                          ? Math.round(
                              (reviewedCards.reduce((sum, c) => {
                                const elapsed = c.lastReview
                                  ? Math.max(
                                      0,
                                      (nowDate - new Date(c.lastReview + 'T12:00:00')) / 86400000
                                    )
                                  : 0
                          ...
                          : 0
                      const recallChartData = recallBands
                        .filter((b) => b.count > 0)
                        .map((b) => ({ name: b.label, value: b.count, fill: b.color }))
                      return (
                        <div
                          style={{
                            display: 'grid',
                        ...
                        >
                          <div
                            style={{
                              ...
                              border: `1px solid ${T.border}`,
                              borderRadius: T.radius,
                              padding: mobile ? '16px 16px 24px' : 28,
                            }}
                          >
                            <div
                              style={{
                          ...
                          >
                            ...
                            >
                              {reviewedCards.length}{' '}
                              {reviewedCards.length === 1 ? t.word : t.wordsPlural}
                            </div>
                            {reviewedCards.length > 0 ? (
                              <div
                                style={{
                              ...
                              >
                                      ...
                                      content={({ active, payload }) => {
                                        if (active && payload && payload.length) {
                                          ...
                                          const pct = Math.round(
                                            (d.value / reviewedCards.length) * 100
                                          )
                                          return (
                                            <div
                                              style={{
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                                  {recallBands.map((band) => {
                                    const pct =
                                      reviewedCards.length > 0
                                        ? Math.round((band.count / reviewedCards.length) * 100)
                                        : 0
                                    return (
                                      <div
                                        key={band.key}
                    ...
                    return (
                      ...
                      >
                            ...
                            >
                              ...
                              <XAxis
                                ...
                                tickFormatter={(value) => {
                                  ...
                                  if (activityRange === 'year')
                                    return d.toLocaleDateString(
                                      settings.lang === 'en' ? 'en-US' : 'pt-BR',
                                      { month: 'short' }
                                    )
                                  return d.toLocaleDateString(
                                    settings.lang === 'en' ? 'en-US' : 'pt-BR',
                        ...
                        >
                          ...
                          />
                          <span
                            style={{ fontFamily: font.body, fontSize: 12, color: T.textTertiary }}
                          >
                            {totalInRange} {t.wordsReviewed.toLowerCase()} ·{' '}
                            {activityRange === 'week'
                              ? t.thisWeek.toLowerCase()
                              : activityRange === 'month'
                                ? t.thisMonth.toLowerCase()
                                : t.thisYear.toLowerCase()}
                          </span>
                        </div>
                      </div>
                    )
        ...
        <Modal
          open={showSnapshotPicker}
          onClose={() => setShowSnapshotPicker(false)}
          title={t.snapshotPickerTitle}
        >
          {snapshotList === null ? (
            <div
              style={{
            ...
            >
              {snapshotList.map((s, i) => {
                ...
                const label = isNaN(d.getTime())
                  ? s.date
                  : `${formatLogDate(localDateStr(d), settings.lang)} · ${d.toLocaleTimeString(settings.lang === 'en' ? 'en-US' : 'pt-BR')}`
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      borderBottom:
                        i === snapshotList.length - 1 ? 'none' : `1px solid ${T.border}`,
                      fontFamily: font.body,
                      fontSize: 13,
                      color: T.text,
                      transition: 'background 0.12s',
        ...
        <Modal
          open={showStudyTimeEditModal}
          onClose={() => setShowStudyTimeEditModal(false)}
          title={t.editTimeLogs}
        >
          {(() => {
                    ...
                    >
                      ...
                      <input
                        ...
                        onKeyDown={(e) => {
                          ...
                          if (e.key === 'Escape') {
                            e.target.value = formatTimeInput(sec)
                            e.target.blur()
                          }
                        }}
                        style={{
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.borderColor = 'rgba(196,72,62,0.2)'
                          e.currentTarget.style.opacity = '1'
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.background = 'transparent'
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
                    ...
                    {[5, 10, 15, 20, 30].map((n) => (
                      <button
                        ...
                        style={{
                          padding: mobile ? '8px 12px' : '8px 16px',
                          background:
                            (settings.newCardsPerDay ?? 10) === n ? T.accent : 'transparent',
                        ...
                        onMouseEnter={(e) => {
                          if ((settings.newCardsPerDay ?? 10) !== n) {
                            e.currentTarget.style.borderColor = T.borderStrong
                            e.currentTarget.style.background = T.bgCardHover
                          }
                        }}
                      ...
                      >
                        ...
                        <span
                          style={{
                            fontFamily: font.body,
                            fontSize: 14,
                            fontWeight: settings.theme === opt.id ? 600 : 400,
                            color: T.text,
                          }}
                        >
                          {opt.label}
                      ...
                      >
                        ...
                        <span
                          style={{
                            fontFamily: font.body,
                            fontSize: 14,
                            fontWeight: settings.lang === opt.id ? 600 : 400,
                            color: T.text,
                          }}
                        >
                          {opt.label}
                      ...
                      >
                        <div
                          style={{
                            fontFamily: font.body,
                            fontSize: 14,
                            fontWeight: settings.cardOrder === opt.id ? 600 : 400,
                            color: T.text,
                          }}
                        >
                          {opt.label}
                ...
                <div>
                  ...
                  <button
                    onClick={() => {
                      const header =
                        'palavra,english,portuguese,due_date,stability,difficulty,reps\n'
                      const rows = cards
                        .map((c) => {
                          const pt = c.phrase
                            ? c.phrase.slice(0, c.keywordStart) +
                              '**' +
                              c.word +
                              '**' +
                              c.phrase.slice(c.keywordEnd)
                            : c.word
                          return [
                            `"${c.word}"`,
                      ...
                      const a = document.createElement('a')
                      a.href = url
                      a.download = `vocabulario_${today()}.csv`
                      a.click()
                      URL.revokeObjectURL(url)
                    }}
                ...
                <div>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const a = document.createElement('a')
                      a.href = url
                      a.download = `vocabulario_study_time_${today()}.csv`
                      a.click()
                      URL.revokeObjectURL(url)
                    }}
                    ...
                    style={{
                      padding: '11px 24px',
                      background: Object.values(studyTime).some((v) => v)
                        ? 'transparent'
                        : T.bgInput,
                      border: `1px solid ${Object.values(studyTime).some((v) => v) ? T.border : 'transparent'}`,
                      borderRadius: T.radiusSm,
                      color: Object.values(studyTime).some((v) => v)
                        ? T.textSecondary
                        : T.textPlaceholder,
                      fontFamily: font.body,
                      fontSize: 13,
                    ...
                    onMouseEnter={(e) => {
                      if (Object.values(studyTime).some((v) => v)) {
                        e.currentTarget.style.borderColor = T.borderStrong
                        e.currentTarget.style.background = T.bgCardHover
                      }
                    }}
                ...
                <div>
                  ...
                  {(() => {
                    ...
                    const formatAgo = (ts) => {
                      ...
                      if (elapsed < 3600000)
                        return `${Math.floor(elapsed / 60000)} ${t.backupHealthMinutesAgo}`
                      if (elapsed < 86400000)
                        return `${Math.floor(elapsed / 3600000)} ${t.backupHealthHoursAgo}`
                      return `${Math.floor(elapsed / 86400000)} ${t.backupHealthDaysAgo}`
                    }
                    const manualAge = lastManualBackup ? now - lastManualBackup : Infinity
                    const manualColor = !lastManualBackup
                      ? T.danger
                      : manualAge > 90 * 86400000
                        ? T.danger
                        : manualAge > 30 * 86400000
                          ? T.warning
                          : T.success
                    const snapAge = lastAutoSnapshot ? now - lastAutoSnapshot : Infinity
                    const snapColor = !settings.scriptUrl
                      ? T.textTertiary
                      : !lastAutoSnapshot
                        ? T.warning
                        : snapAge > 14 * 86400000
                          ? T.warning
                          : T.success
                    const syncColor = !settings.scriptUrl
                      ? T.textTertiary
                      : syncStatus === 'synced'
                        ? T.success
                        : syncStatus === 'error'
                    ...
                    return (
                      ...
                      >
                        ...
                        {row(
                          t.backupHealthLastSnapshot,
                          settings.scriptUrl ? formatAgo(lastAutoSnapshot) : '—',
                          snapColor
                        )}
