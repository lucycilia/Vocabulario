...
// Apply RemNote due dates to cards (one-time migration)
const applyRemnoteDueDates = (cards) => {
  // Build lookup: normalize text -> {dueDate, reps}
    ...
    const load = async () => {
      ...
      if (sUrl) {
        ...
        try {
          ...
          const finalCards = didRemnoteMigration ? applyRemnoteDueDates(merged) : merged;
          setCards(finalCards);
          setPracticeDays(mergedDays);
