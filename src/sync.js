...
export const pushCard = (card) => update(ref(db, `${ROOT}/cards`), { [card.id]: card })
...
export const pushPracticeDays = (practiceDays) => update(ref(db, ROOT), { practiceDays })

export const pushDeleted = (deletedCards) => update(ref(db, ROOT), { deletedCards })

export const pushStudyTime = (studyTime) => update(ref(db, ROOT), { studyTime })
